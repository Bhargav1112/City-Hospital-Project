...
function Apointments(props) {
    ...
    const schema = yup.object().shape({
        ...
        message: yup.string().max(50, 'Maximum 50 charecters allowed').required('Required')
    })
            ...
            <section id="appointment" className="appointment">
                <div className="container">
                    <div className="section-title">
                        ...
                        <p>
                            Aenean enim orci, suscipit vitae sodales ac, semper
                            in ex. Nunc aliquam eget nibh eu euismod. Donec
                            dapibus blandit quam volutpat sollicitudin. Fusce
                            tincidunt sit amet ex in volutpat. Donec lacinia
                            finibus tortor. Curabitur luctus eleifend odio.
                    ...
                    >
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 form-group mt-3">
                                ...
                                {errors.select && touched.select && <p className="text-danger">{errors.select}</p>}
                            </div>
                        </div>
